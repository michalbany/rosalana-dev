...
This is a composable that provides all the logic for the table. When you use your table, you create a new instance of this composable and pass it the configuration object.
...
This is a component that uses the composable and provides the UI for the table. Code below is a simplified version for demonstration purposes. Component is using [Ui-thing library](https://ui-thing.behonbaker.com/getting-started/introduction) for UI components.
...
<script lang="ts" setup>
  ...
  // Filter logic
  const applySearchFilter = (item: any): boolean => {
  ...
  const applySelectFilter = (item: any) => {
  ...
  <div>
    ...
    <div class="mb-5">
      ...
      <div class="mb-2 mt-2 flex flex-wrap gap-x-2">
        <div v-for="(filter, index) in filters" :key="index">
          <div class="mt-1 flex w-min items-center gap-2 rounded bg-slate-200 p-1">
            <UiSelect
    ...
    <template v-else>
      <div class="mb-3 flex items-center justify-between border-b px-3 py-1.5">
        ...
        <VTRender :content="table.columns.bind('action')?.header" :item="table" />
      </div>
      ...
      <div class="grid-container gap-6">
        ...
        >
          <div class="relative mb-4 flex items-center gap-3 self-start font-semibold text-action">
          ...
          <div class="mt-2 flex items-center self-end">
            <VTRender :content="table.columns.bind('status')?.content()" :item="row" />
            <VTRender
...
This is an example of how to use the `VisualTable` component in a parent component.
...
::alert{type="danger"}
Detail information about the `VisualTable` component API will be added soon.
::
